        ...
        ?>
            ...
            <div class="col-md-6 col-lg-4 mb-4" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
                <a href="<?echo $arItem["DETAIL_PAGE_URL"]?>" class="prop-entry d-block">
                    ...
                    <div class="prop-text">
                        <div class="inner">
                            <span class="price rounded"><?echo $arItem["PROPERTY_PRICE_VALUE"]?> рублей</span>
                        ...
                        <div class="prop-more-info">
                            <div class="inner d-flex">
                                ...
                                <div class="col">
                                    ...
                                    <strong><?echo $arItem["PROPERTY_FLOORS_VALUE"]?></strong>
                                </div>
                                <div class="col">
                                    <span><?=GetMessage("BATHROOMS")?></span>
                                    <strong><?echo $arItem["PROPERTY_BATHROOMS_VALUE"]?></strong>
                                </div>
                                <div class="col">

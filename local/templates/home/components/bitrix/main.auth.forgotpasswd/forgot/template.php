...
<div class="site-section">
	...
	<form name="bform" method="post" target="_top" action="<?= POST_FORM_ACTION_URI;?>" class="p-5 bg-white border">
		<div class="row form-group">
			<div class="col-md-12">
				<label class="font-weight-bold"><?= Loc::getMessage('MAIN_AUTH_PWD_FIELD_LOGIN');?></label>
				<input class="form-control" type="text" name="<?= $arResult['FIELDS']['login'];?>" maxlength="255" value="<?= \htmlspecialcharsbx($arResult['LAST_LOGIN']);?>" />
			</div>
		</div>
		<div class="row form-group">
			<div class="col-md-12">
				<label class="font-weight-bold"><?= Loc::getMessage('MAIN_AUTH_PWD_OR');?></label>
			</div>
		</div>
		<div class="row form-group">
			<div class="col-md-12">
				<label class="font-weight-bold"><?= Loc::getMessage('MAIN_AUTH_PWD_FIELD_EMAIL');?></label>
				<input class="form-control" type="text" name="<?= $arResult['FIELDS']['email'];?>" maxlength="255" value="" />
			</div>
		</div>

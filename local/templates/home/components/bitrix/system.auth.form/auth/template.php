					...
					<form name="system_auth_form<?= $arResult["RND"] ?>" method="post" target="_top"
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input class="form-control" type="password" name="USER_PASSWORD" maxlength="255" size="17"
									   autocomplete="off"/>
						...
						<div class="row form-group">
							<div class="col-md-12">
								<input type="submit" name="Login"
									   value="<?= GetMessage("AUTH_LOGIN_BUTTON") ?>" class="btn btn-primary  py-2 px-4 rounded-0">
							</div>
						</div>
